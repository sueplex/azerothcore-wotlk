...
enum PlayerbotsDatabaseStatements : uint32
{
    ...
    */
    ...
    PLAYERBOTS_SEL_PVP_BOTS_VALUE,
    PLAYERBOTS_SEL_PVP_BOTS_BOT,
    PLAYERBOTS_SEL_PVP_BOTS_BY_OWNER_AND_EVENT,
    PLAYERBOTS_SEL_PVP_BOTS_BY_OWNER_AND_BOT,
    PLAYERBOTS_SEL_PVP_BOTS_BY_EVENT_AND_VALUE,
    PLAYERBOTS_INS_PVP_BOTS,
    PLAYERBOTS_DEL_PVP_BOTS,
    PLAYERBOTS_DEL_PVP_BOTS_BY_OWNER,
    PLAYERBOTS_DEL_PVP_BOTS_BY_OWNER_AND_EVENT,
    PLAYERBOTS_UPD_PVP_BOTS,
